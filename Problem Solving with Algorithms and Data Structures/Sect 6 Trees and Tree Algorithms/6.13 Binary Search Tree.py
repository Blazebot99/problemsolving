...
#Note that if the BST Property is maintained, all nodes to the left of a root will be smaller than the root and all nodes to the right of a root will be greater than the root.
